  ...
  return (
    <main>
      <section className="bg-gradient-to-r from-blue-600 to-blue-500">
        <motion.div initial={{ opacity: 0, y: -100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-screen-xl mx-auto xl:flex xl:text-left text-center justify-between items-center px-4 md:pt-72 md:py-0 pt-56 py-24">
          <div>
            <h1 className="md:text-8xl sm:text-6xl text-4xl font-semibold text-zinc-50 py-4">Securepass</h1>
          ...
          <Image src={"/assets/image.png"} width={600} height={500} alt={"Strong & Secure"} className="md:block hidden xl:mt-0 mt-16 xl:mx-0 mx-auto" />
        </motion.div>
