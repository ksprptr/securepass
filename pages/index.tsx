...
export default function Generator() {
  return (
    <main>
      ...
      <motion.section initial={{ opacity: 0, y: -100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.25 }} className="py-32 max-w-screen-xl mx-auto px-4">
      ...
      <motion.section initial={{ opacity: 0, y: -100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.25 }} className="py-32 max-w-screen-xl mx-auto px-4 text-right">
        ...
        <div className="mt-8">
          <Link href="/generate" className="btn md:text-xl text-lg">
            Generate
          </Link>
        </div>
      </motion.section>
