  ...
  return (
    <nav className={`bg-zinc-100 z-10 fixed w-full text-zinc-800 ${colorChange && "shadow-xl"}`}>
      <div ref={navRef}>
        ...
        <motion.div initial={{ height: 0 }} animate={{ height: navbar ? "auto" : 0 }} transition={{ duration: 0.5 }} className="flex-col gap-y-2 text-right text-xl bg-zinc-100 overflow-hidden px-4">
          <ul>
            <li>
